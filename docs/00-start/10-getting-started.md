...
This page gets you from an empty project to a waveform drawn on screen, and then to a recording on disk.
...
See [platform notes](../20-reference/10-platforms.md) for what each target needs.
...
More in [decoding](../10-guides/00-decoding.md).
...
[Drawing](../10-guides/10-drawing.md) covers zoom, pan, the playhead and the repaint traps.
...
[Capture](../10-guides/20-capture.md) covers the live meter, pause and resume, and why there are two rings.
